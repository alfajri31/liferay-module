 ...
 * <code>com.docs.guestbook.service.impl.EntryLocalServiceImpl</code> and
...
public class EntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.docs.guestbook.service.impl.EntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addEntrySpecified(String name, String message) {
		getService().addEntrySpecified(name, message);
	}
	...
	public static List<Entry> getAllEntry() {
		return getService().getAllEntry();
	}

	public static List<Entry> getAllEntryE() {
		return getService().getAllEntryE();
	}
	...
	public static void updateEntrySpecified(
			String name, String message, Long entryId)
		throws PortalException {

		getService().updateEntrySpecified(name, message, entryId);
	}
